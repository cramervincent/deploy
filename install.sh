#!/bin/bash
# install.sh - FINALE VERSIE (MET NGINX ROOT FIX)
...
server {
    ...
    # --- HIER IS DE FIX: 'alias' is vervangen door 'root' ---
    # Dit zorgt ervoor dat Nginx in de juiste map zoekt naar de _nuxt bestanden.
    location /_nuxt {
